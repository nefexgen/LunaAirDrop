...
public class CAirDrop implements AirDrop, StateSerializable {
    ...
    private SpreadingItemsManager spreadingItemsManager = null;
    ...
    CAirDrop(FileConfiguration fileConfiguration, File airDropFile) {
        ...
        try {
            ...
            spreadingItemsManager = new SpreadingItemsManager(this);
    ...
    public void save() {
        ...
        if (spreadingItemsManager != null) {
            spreadingItemsManager.saveConfig(fileConfiguration);
        }
    ...
    public void unlock() {
        ...
        if (spreadingItemsManager != null && spreadingItemsManager.shouldTriggerOn("OPEN")) {
            spreadItems();
        }
    ...
    public void End() {
        ...
        if (spreadingItemsManager != null && spreadingItemsManager.shouldTriggerOn("END")) {
            spreadItems();
        }
...
//        map.put("okeeeey", mm);
    ...
    @Override
    public boolean isSpreadingItemsEnabled() {
        return spreadingItemsManager != null && spreadingItemsManager.isEnabled();
    }

    @Override
    public void setSpreadingItemsEnabled(boolean enabled) {
        if (spreadingItemsManager != null) {
            spreadingItemsManager.setEnabled(enabled);
        }
    }

    @Override
    public String getSpreadingItemsTrigger() {
        return spreadingItemsManager != null ? spreadingItemsManager.getTrigger() : "END";
    }

    @Override
    public void spreadItems() {
        if (spreadingItemsManager != null) {
            spreadingItemsManager.spread();
        }
    }
    
    @Override
    public SpreadingItemsManager getSpreadingItemsManager() {
        return spreadingItemsManager;
    }
